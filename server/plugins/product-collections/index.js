    ...
    server.route([
        ...
        },
        {
            ...
            options: {
                ...
                handler: (request, h) => {
                    return ProductCollectionCtrl.createHandler(request, h);
                }
            }
        },
        {
            ...
            options: {
                ...
                handler: (request, h) => {
                    return ProductCollectionCtrl.updateHandler(request, h);
                }
            }
        },
        {
            ...
            options: {
                ...
                handler: (request, h) => {
                    return ProductCollectionCtrl.deleteHandler(request.query.id, h);
                }
            }
        }
    ]);
